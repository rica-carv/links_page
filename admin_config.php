...
/*
		...
		'link_category_id' =>   array ( 'title' => LAN_ID, 'data' => 'int', 'width' => '5%', 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left',  ),
		'link_category_name' =>   array ( 'title' => LCLAN_ITEM_2, 'type' => 'dropdown', 'data' => 'int', 'width' => 'auto', 'batch' => true, 'filter' => true, 
	   'inline' => true,   'help' => '', 'readParms' => '', 'writeParms' => array('size'=>'block-level', 'required'=>1), 'class' => 'left', 'thclass' => 'left',  ),
		'link_category_description' =>   array ( 'title' => LCLAN_ITEM_6, 'type' => 'textarea', 'data' => 'str', 'width' => '40%', 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left',  ),
		'link_category_icon' =>   array ( 'title' => LCLAN_ITEM_14, 'type' => 'icon', 'data' => 'str', 'width' => 'auto', 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left',  ),
		'link_category_order' =>   array ( 'title' => LAN_ORDER, 'type' => 'number', 'data' => 'int', 'width' => 'auto', 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left',  ),
		'link_category_class' =>   array ( 'title' => LCLAN_ITEM_20, 'type' => 'userclass', 'data' => 'int', 'width' => 'auto', 
	  'batch' => true, 'filter' => true, 'inline' => true, 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left',  ),
 		'link_category_datestamp' =>   array ( 'title' => LCLAN_CREATED,  'type' => 'datestamp',   
		'data' => 'int', 'width' => 'auto', 'help' => '', 
		'readParms' => '',   /*'readonly' => true,  todo *//*
		'parms' => 'mask=%A %d %B %Y',
		'writeParms' => 'type=datetime', 'class' => 'left', 'thclass' => 'left',  ),
		'link_category_sef' =>   array ( 'title' => LAN_SEFURL, 'type' => 'userclass', 'data' => 'int', 'width' => 'auto', 
	  'batch' => true, 'filter' => true, 'inline' => true, 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left',  ),
	  );		
	  */
        ...
        'writeParms' => array('size'=>'block-level' ), 'class' => 'left', 'thclass' => 'left',  ),
		  'link_category_icon' =>   array ( 'title' => LCLAN_CAT_22, 'type' => 'icon', 'data' => 'str', 'width' => 'auto', 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left',  ),
		  'link_category_order' =>   array ( 'title' => LAN_ORDER, 'type' => 'number', 'data' => 'int', 'width' => 'auto', 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left',  ),
		  'link_category_class' =>   array ( 'title' => LCLAN_CAT_24, 'type' => 'userclass', 'data' => 'str', 'width' => 'auto', 'batch' => true, 'filter' => true, 'inline' => true, 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left',  ),
		  'link_category_datestamp' =>   array ( 'title' => LAN_DATE, 'type' => 'datestamp', 
        'data' => 'int', 'parms' => 'mask=%A %d %B %Y', 'width' => 'auto', 'filter' => true, 
        'help' => '', 'readParms' => '', 'writeParms' => 'type=datetime', 'class' => 'left', 'thclass' => 'left',  ),
      'link_category_sef' => array ( 'title' => LAN_SEFURL, 'type' => 'text', 'inline'=>true, 'width' => 'auto', 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left', ), 
...
class links_page_ui extends e_admin_ui
{
	...
	//	protected $orderStep		= 10;
  	...
  	protected $listQry      	= "SELECT * FROM `#links_page` WHERE link_active != '0' "; // Example Custom Query. LEFT JOINS allowed. Should be without any Order or Limit.
		...
		protected $fields 		= array (  'checkboxes' =>   array ( 'title' => '', 'type' => null, 'data' => null, 'width' => '5%', 'thclass' => 'center', 'forced' => '1', 'class' => 'center', 'toggle' => 'e-multiselect',  ),
		  'link_id' =>   array ( 'title' => LAN_ID, 'data' => 'int', 'width' => '5%', 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left',  ),
        ...
        'help' => '', 'readParms' => '', 'writeParms' => array('size'=>'block-level', 'required'=>1), 'class' => 'left', 'thclass' => 'left',  ),
		  'link_description' =>   array ( 'title' => LCLAN_ITEM_6, 'type' => 'textarea', 'data' => 'str', 'width' => '40%', 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left',  ),
		  'link_button' =>   array ( 'title' => LCLAN_ITEM_14, 'type' => 'icon', 'data' => 'str', 'width' => 'auto', 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left',  ),

		  'link_order' =>   array ( 'title' => LAN_ORDER, 'type' => 'number', 'data' => 'int', 'width' => 'auto', 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left',  ),
        ...
        'batch' => true, 'filter' => true, 'inline' => true, 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left',  ),
          ...
          'parms' => 'mask=%A %d %B %Y',
          'writeParms' => 'type=datetime', 'class' => 'left', 'thclass' => 'left',  ),
		  'link_author' =>   array ( 'title' => LAN_AUTHOR, 'type' => 'user', 'data' => 'str', 'width' => 'auto', 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left',  ),
...
class links_submitted_ui extends e_admin_ui
{
	...
	//	protected $tabs				= array('Tabl 1','Tab 2'); // Use 'tab'=>0  OR 'tab'=>1 in the $fields below to enable. 
  	...
  	protected $listQry      	= "SELECT * FROM `#links_page` WHERE link_active = '0' "; // Example Custom Query. LEFT JOINS allowed. Should be without any Order or Limit.
		...
		protected $fields 		= array (  'checkboxes' =>   array ( 'title' => '', 'type' => null, 'data' => null, 'width' => '5%', 'thclass' => 'center', 'forced' => '1', 'class' => 'center', 'toggle' => 'e-multiselect',  ),
		  'link_id' =>   array ( 'title' => LAN_ID, 'data' => 'int', 'width' => '5%', 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left',  ),
		  'link_category' =>   array ( 'title' => LCLAN_ITEM_2, 'type' => 'dropdown', 'data' => 'int', 'width' => 'auto', 'batch' => true, 'filter' => true, 'inline' => true, 'help' => '', 'readParms' => '',  'class' => 'left', 'thclass' => 'left',  ),
