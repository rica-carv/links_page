...
class links_page_ui extends e_admin_ui
{
	...
	//	protected $tabs				= array('Tabl 1','Tab 2'); // Use 'tab'=>0  OR 'tab'=>1 in the $fields below to enable. 
      ...
      'link_comment'		=> array('title'=> LCLAN_OPT_55, 'tab'=>0, 'type'=>'boolean', 'data' => 'str', 'help'=>'Help Text goes here'),
			...
			'link_rating'		=> array('title'=> LCLAN_OPT_27, 'tab'=>0,'type'=>'boolean','data' => 'str', 'help'=>'Help Text goes here'),
			
      
      'link_navigator_frontpage'		=> array('title'=> LCLAN_OPT_60, 'tab'=>0, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),
      'link_navigator_submit'		=> array('title'=> LCLAN_OPT_58, 'tab'=>0, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),
      'link_navigator_manager'		=> array('title'=> LCLAN_OPT_59, 'tab'=>0, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),
      'link_navigator_refer'		=> array('title'=> LCLAN_OPT_20, 'tab'=>0, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),
      'link_navigator_rated'		=> array('title'=> LCLAN_OPT_21, 'tab'=>0, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),
      'link_navigator_allcat'		=> array('title'=> LCLAN_OPT_66, 'tab'=>0, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),
      'link_navigator_links'		=> array('title'=> LCLAN_OPT_67, 'tab'=>0, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),
      'link_navigator_category'		=> array('title'=> LCLAN_OPT_61, 'tab'=>0, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),      
           
      'link_manager'		=> array('title'=> LCLAN_OPT_54, 'tab'=>1, 'type'=>'boolean', 'data' => 'str', 'help'=>'Help Text goes here'),        
      'link_manager_class'		=> array('title'=> LCLAN_OPT_46, 'tab'=>1, 'type'=>'userclass', 'data' => 'str', 'help'=>'these users can add/edit their own personal links'),
      'link_directpost'		=> array('title'=> LCLAN_OPT_48, 'tab'=>1, 'type'=>'boolean', 'data' => 'str', 'help'=>'if enabled links are submitted directly, else a site admin needs to approve them'),
      'link_directdelete'		=> array('title'=> LCLAN_OPT_50, 'tab'=>1, 'type'=>'boolean', 'data' => 'str', 'help'=>'if enabled the link managers can delete their own links'),
                        
      'link_cat_icon'		=> array('title'=> LCLAN_OPT_14, 'tab'=>2, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),        
      'link_cat_desc'		=> array('title'=> LCLAN_OPT_15, 'tab'=>2, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),        
      'link_cat_amount'		=> array('title'=> LCLAN_OPT_16, 'tab'=>2, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),        
      'link_cat_total'		=> array('title'=> LCLAN_OPT_19, 'tab'=>2, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),        
      'link_cat_empty'		=> array('title'=> LCLAN_OPT_65, 'tab'=>2, 'type'=>'boolean', 'data' => 'str', 'help'=>'Help Text goes here'),        
      'link_cat_icon_empty'		=> array('title'=> LCLAN_OPT_22, 'tab'=>2, 'type'=>'boolean', 'data' => 'str', 'help'=>'Help Text goes here'),        
      'link_cat_sortorder'		=> array('title'=> LCLAN_OPT_29, 'tab'=>2, 'type'=>'boolean', 'data' => 'str', 'help'=>'Help Text goes here'),        
      'link_cat_sort'		=> array('title'=> LCLAN_OPT_23, 'tab'=>2, 'type'=>'dropdown', 'data' => 'str', 'help'=>'Help Text goes here'),       
      'link_cat_order'		=> array('title'=> LCLAN_OPT_24, 'tab'=>2, 'type'=>'dropdown', 'data' => 'str', 'help'=>'Help Text goes here'),        
      'link_cat_resize_value'		=> array('title'=> LCLAN_OPT_25, 'tab'=>2, 'type'=>'text', 'data' => 'str', 'help'=>'Help Text goes here'),         
      'link_icon'		=> array('title'=> LCLAN_OPT_14, 'tab'=>3, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),
      'link_referal'		=> array('title'=> LCLAN_OPT_17, 'tab'=>3, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),
      'link_url'		=> array('title'=> LCLAN_OPT_18, 'tab'=>3, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),
      'link_desc'		=> array('title'=> LCLAN_OPT_15, 'tab'=>3, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),
      'link_icon_empty'		=> array('title'=> LCLAN_OPT_22, 'tab'=>3, 'type'=>'boolean', 'data' => 'str', 'help'=>'Help Text goes here'),
      'link_sortorder'		=> array('title'=> LCLAN_OPT_29, 'tab'=>3, 'type'=>'boolean', 'data' => 'str', 'help'=>'Help Text goes here'),        
      'link_sort'		=> array('title'=> LCLAN_OPT_23, 'tab'=>3, 'type'=>'dropdown', 'data' => 'str', 'help'=>'Help Text goes here'),       
      'link_order'		=> array('title'=> LCLAN_OPT_23, 'tab'=>3, 'type'=>'dropdown', 'data' => 'str', 'help'=>'Help Text goes here'),
         //????  0=same window, 1=_blank, 2=_parent, 3=_top, 4=miniwindow
      'link_open_all'		=> array('title'=> LCLAN_OPT_32, 'tab'=>3, 'type'=>'dropdown', 'data' => 'str', 'help'=>'Help Text goes here'),
      'link_cat_resize_value'		=> array('title'=> LCLAN_OPT_33, 'tab'=>3, 'type'=>'text', 'data' => 'str', 'help'=>'Help Text goes here'),        
       
      'link_refer_minimum'		=> array('title'=> LCLAN_OPT_56, 'tab'=>4, 'type'=>'text', 'data' => 'str', 
        'help'=>'only links with a refer count larger then the given value are displayed (0 or empty = all)'),       
      'link_rating_minimum'		=> array('title'=> LCLAN_OPT_63, 'tab'=>5, 'type'=>'text', 'data' => 'str', 
        'help'=>'only links with a rating larger then the given value are displayed (0 or empty = all)'),         
 
      'link_menu_caption'		=> array('title'=> LCLAN_OPT_85, 'tab'=>6, 'type'=>'text', 'data' => 'str', 'help'=>'Help Text goes here'), 
      'link_menu_navigator_frontpage'		=> array('title'=> LCLAN_OPT_60, 'tab'=>6, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),  
      'link_menu_navigator_submit'		=> array('title'=> LCLAN_OPT_58, 'tab'=>6, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'),  
      'link_menu_navigator_manager'		=> array('title'=> LCLAN_OPT_58, 'tab'=>6, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'), 
      'link_menu_navigator_refer'		=> array('title'=> LCLAN_OPT_58, 'tab'=>6, 'type'=>'checkbox', 'data' => 'str', 'help'=>'Help Text goes here'), 
      ...
      'link_menu_category_amount'		=> array('title'=> LCLAN_OPT_87, 'tab'=>6, 'type'=>'boolean', 
        'data' => 'str', 'help'=>'Help Text goes here'),   
      'link_menu_category_rendertype'		=> array('title'=> LCLAN_OPT_71, 'tab'=>6, 'type'=>'dropdown', 
        'data' => 'str', 'help'=>'Help Text goes here'),
      'link_menu_recent'		=> array('title'=> LCLAN_OPT_77, 'tab'=>6, 'type'=>'boolean', 
        'data' => 'str', 'help'=>'Help Text goes here'),
      'link_menu_recent_category'		=> array('title'=> LCLAN_OPT_77, 'tab'=>6, 'type'=>'checkbox', 
        'data' => 'str', 'help'=>'Help Text goes here'),
      'link_menu_recent_description'		=> array('title'=> LCLAN_OPT_78, 'tab'=>6, 'type'=>'checkbox', 
        'data' => 'str', 'help'=>'Help Text goes here'),
      'link_menu_recent_caption'		=> array('title'=> LCLAN_OPT_81, 'tab'=>6, 'type'=>'text', 
          'data' => 'str', 'help'=>'Help Text goes here'),        
      'link_menu_recent_number'		=> array('title'=> LCLAN_OPT_74, 'tab'=>6, 'type'=>'text', 
