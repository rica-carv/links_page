...
if (!defined('LINK_ICON_EDIT')) { define("LINK_ICON_EDIT", ADMIN_EDIT_ICON); }
if (!defined('LINK_ICON_DELETE')) { define("LINK_ICON_DELETE", ADMIN_DELETE_ICON); }
if (!defined('LINK_ICON_DELETE_BASE')) { define("LINK_ICON_DELETE_BASE", ADMIN_DELETE_ICON); }
