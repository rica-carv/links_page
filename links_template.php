...
$LINK_TABLE_MANAGE_START = "
	...
	<table class='table table-striped table-bordered table-hover fborder' style='width:100%;' cellspacing='0' cellpadding='0'>
	<tr>
...
$LINK_MAIN_TABLE = "
	<table class='table table-striped table-bordered table-hover fborder' style='width:100%; margin-bottom:20px;' cellspacing='0' cellpadding='0'>
	<tr>
		{LINK_MAIN_ICON}
...
$LINK_TABLE_START = "{NAVIGATOR}
	<div style='text-align:center'>
	<table class='table table-striped table-bordered table-hover fborder' style='".USER_WIDTH.";margin-bottom:20px;'>
	<tr>
